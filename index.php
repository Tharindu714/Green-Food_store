    ...
    <div class="container-fluid vh-100 d-flex justify-content-center align-content-center" style="background-color: rgba(0, 0, 0, 0.10);">
        <div class="row d-flex align-content-center justify-content-center">
            <div class="col-10 col-lg-4" id="signUpBox">
                <div class="row g-2 d-flex justify-content-center  mx-2 rounded-4" style="background-color: rgba(1, 89, 60, 0.93);">
                    ...
                    <div class="col-10  d-grid mt-2">
                        <button class="btn f2" style="background-color: #01593c; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="signUp();">Sign Up</button>
                    </div>

                    <div class="col-10 d-grid mt-2 mb-4">
                        <button class="btn f2" style="background-color: #02d592; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset; " onclick="changeView();">Already have an account? Sign In</button>
                    </div>
            ...
            <div class="col-10 col-lg-4 d-none" id="signInBox">
                <div class="row g-2 d-flex justify-content-center  mx-2 rounded-4" style="background-color: rgba(1, 89, 60, 0.93);">
                    ...
                    <div class="col-10">
                        ...
                        <input type="email f1" class="form-control" id="email2" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" value="<?php echo $email; ?>"  />
                    </div>
                    <div class="col-10">
                        <label class="form-label f1" style="color: white;">Password</label>
                        <input type="password" class="form-control" id="password2" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" value="<?php echo $password; ?>"/>
                    </div>
                    <div class="col-5">
                    ...
                    <div class="col-5 text-end">
                        <a href="#" class="link-success f1" onclick="forgotPassword();">Forgot Password?</a>
                    </div>


                    <div class="col-10 d-grid mt-2">
                        <button class="btn f2" style="background-color: #02d592; color: white; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="signIn();">Sign In</button>
                    </div>
                    <div class="col-10  d-grid mt-2 mb-4">
                        <button class="btn f2" style="background-color: #01593c; color: white; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="changeView();">New Member? Sign Up</button>
                    </div>
        ...
        <div class="modal" tabindex="-1" id="forgotPasswordModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: rgba(1, 89, 60, 0.93);">
                    ...
                    <div class="modal-footer mt-2" style="background-color: rgba(1, 89, 60, 0.93);">
        ...
        <div class="col-12 fixed-bottom d-none d-lg-block">
            <p class="text-center">&copy; 2024 freshFood.com || All Right Reserved</p>
        </div>
