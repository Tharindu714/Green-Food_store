      ...
      <div class="col-12" style="background-color: #2b2d42; height: 30px;">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb"  style="background-color: #2b2d42;">
            ...
            <li class="breadcrumb-item text-light fw-bold f3 fs-2 my-1" aria-current="page"><?php echo $_SESSION["product"]["title"]; ?> is on a Update process...</li>
          </ol>
        </nav>
      </div>
      <br>
      <div class="col-12">
        <div class="row">
          ...
          <div class="offset-lg-4 col-12 col-lg-4 d-grid mt-3 mb-3">
            <button class="btn btn-outline-primary fw-bold text-white" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="Updateproduct();">Update Product</button>
          </div>
